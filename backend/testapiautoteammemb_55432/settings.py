"""
Django settings for testapiautoteammemb_55432 project.
...
ROOT_URLCONF = 'testapiautoteammemb_55432.urls'
...
WSGI_APPLICATION = 'testapiautoteammemb_55432.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "testapiautoteammemb_55432 API",
    "DESCRIPTION": "API documentation for testapiautoteammemb_55432 App",
    "VERSION": "v1",
}
