...
## Project Structure
    ...
    ├── testapiautoteammemb_55432  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_55432`
...
2. Clone this repo and `cd testapiautoteammemb_55432`
